...
export class InitDB1744384855087 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "casts" ("id" SERIAL NOT NULL, "name" character varying(30) NOT NULL, "en_name" character varying(30) NOT NULL, "introduce_tweet_id" character varying(100) NOT NULL, "type" "${this.schema}"."casts_type_enum" NOT NULL, "is_active" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_a7f4a967c0ef1bed2585ff061b7" PRIMARY KEY ("id"))`);
