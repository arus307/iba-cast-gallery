...
export class InitDB1744384855087 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "${this.schema}"."post_cast_tags" ("post_id" character varying(30) NOT NULL, "cast_id" integer NOT NULL, CONSTRAINT "PK_17fa77740414b39f9b223b001d6" PRIMARY KEY ("post_id", "cast_id"))`);
